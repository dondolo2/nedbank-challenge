...
Submit your Git repository URL on the Nedbank Innovate Challenge platform before the stage closes.

The evaluation system clones your repository, builds your Docker image, and runs your pipeline against the evaluation dataset. You do not need to be available for the scoring run.
...
**Inputs (mounted at runtime by the evaluation system):**
...
Scoring is fully automated across four dimensions. The evaluation system runs your pipeline, inspects the output, and analyses your code.

| Dimension | Weight | What Is Measured |
|---|---|---|
| **Correctness** | 40% | Do your outputs match expected results? Do the validation queries pass? |
| **Scalability** | 25% | Does your pipeline complete within the time limit? Does it stay within memory limits? |
| **Maintainability** | 20% | Is configuration externalised? Are your modules separable? Is your code structured for change? |
| **Efficiency** | 15% | Are you using Spark idiomatically? Are you avoiding redundant full-dataset scans? |
...
**Format:**
- Technical interrogation per finalist
- Panel: Nedbank senior data engineers (the people who designed this challenge) and the challenge lead
...
Top-performing participants will be eligible for potential employment opportunities at Nedbank. Outstanding candidates from both tracks will be fast-tracked into Nedbank's hiring process, with outreach following the on-site event.
...
- **Download** the data pack and base Docker image from the Nedbank Innovate Challenge platform. The pack includes:
...
- **Submit** your repository URL on the Nedbank Innovate Challenge platform. You will be notified when each stage opens.
